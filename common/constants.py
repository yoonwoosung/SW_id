...
COURSE_PLACE_RULES = {
    ...
    # ── 액티비티(대분류째 감춘 상태) ──
    # 관광공사 코드로는 승마·등산·자전거를 구분할 수 없다(모두 육상 레포츠 A0303).
    # 카약·낚시도 마찬가지다(모두 수상 레포츠 A0302). 억지로 나누면 틀린 판정이 된다.
    # 게다가 A03 자체가 표본에 한 건도 없었다. 데이터가 생기면 되살린다.
    "horse_riding": {"cat2": "A0303"},
    "hiking":       {"cat2": "A0303"},
    "cycling":      {"cat2": "A0303"},
    "kayak":        {"cat2": "A0302"},
    "fishing":      {"cat2": "A0302"},
