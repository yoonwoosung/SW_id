...
## 2-1. 사용자 편의 기능 (User Convenience)
### 🌱 일반 사용자 (Experiencers)
- **직관적인 맞춤형 UI**: 마감 임박 경고와 색상별 해시태그를 적용하여, 농장의 핵심 정보와 예약 상황을 한눈에 파악하고 빠르게 결정할 수 있습니다. 
- **위치 기반 스마트 추천**: 사용자의 현재 위치를 인식하여 가장 가까운 농장을 거리순으로 자동 안내함으로써 정보 탐색의 번거로움을 덜어줍니다.
- **AI 기반 후기 요약**: AI가 수많은 후기 속에서 장단점 키워드만 자동으로 추출하고 요약해 주어, 체험 선택 시 느끼는 피로도를 크게 줄여줍니다.
